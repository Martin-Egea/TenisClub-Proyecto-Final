...
export default function LoginPage() {
  ...
  return (
    <div className="bg-gradient-to-br from-orange-950 via-amber-500 to-orange-950 flex justify-center items-center h-screen  ">
      <div className="flex justify-center items-center w-screen h-screen bg-cover bg-no-repeat bg-center bg-opacity-20">
        <img
          src="https://services.meteored.com/img/article/torneio-de-tenis-us-open-em-nova-iorque-reajusta-se-aos-novos-desafios-impostos-pelas-alteracoes-climaticas-1724693275614_512.jpeg"
